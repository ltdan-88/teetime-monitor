...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "picker.club_search_placeholder": "Search clubs, or type a club id…",
        "picker.favorites_hint": "Your favorites — enter to open. Type to search all {count} clubs — 'f' favorites, 'r' refreshes the list.",
        "picker.no_favorites_hint": "No favorites yet. Type a club name to search, or a club id (e.g. 0000001).",
        ...
        "picker.no_directory_yet": "No club list downloaded yet — press 'r' to fetch it, or type a club id.",
        "picker.directory_needs_login": "Fetching the club list needs a login — set one up with 'python -m src.credentials_screen'.",
        ...
        "settings.field.ai_assist_model": "AI model",
        ...
        "heatmap.day_type.weekend": "Weekend",
        "heatmap.day_type.workday": "Workday",
        ...
        "heatmap.preview_title": "Hourly pattern (ready day types only)",
        "heatmap.no_preview": "No day type has enough data for a preview yet.",
    },
    "de": {
        ...
        "picker.club_search_placeholder": "Clubs suchen oder Club-ID eingeben…",
        ...
        "picker.no_favorites_hint": "Noch keine Favoriten. Clubnamen eingeben, um zu suchen, oder eine Club-ID (z. B. 0000001).",
        ...
        "picker.no_directory_yet": "Noch keine Clubliste geladen — mit 'r' abrufen oder eine Club-ID eingeben.",
        "picker.directory_needs_login": "Für die Clubliste ist ein Login nötig — einrichten mit 'python -m src.credentials_screen'.",
        ...
        "settings.field.ai_assist_model": "KI-Modell",
        ...
        "heatmap.day_type.weekend": "Wochenende",
        "heatmap.day_type.workday": "Werktag",
        ...
        "heatmap.preview_title": "Stündliches Muster (nur bereite Tagestypen)",
        "heatmap.no_preview": "Noch kein Tagestyp hat genug Daten für eine Vorschau.",
    },
}
