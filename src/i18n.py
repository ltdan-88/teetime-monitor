...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "binding.confirm_or_cancel": "Confirm/cancel tee time",
        "binding.expand_or_confirm": "Expand day / confirm tee time",
        "binding.open_day": "Open full day view",
        ...
        "command.open_day_description": "Full single-day view — booking-change banners, manual refresh",
    ...
    "de": {
        ...
        "binding.confirm_or_cancel": "Tee-Zeit bestätigen/stornieren",
        "binding.expand_or_confirm": "Tag aufklappen / Tee-Zeit bestätigen",
        "binding.open_day": "Ganze Tagesansicht öffnen",
        ...
        "command.switch_description": "Den gesamten Club-Katalog durchsuchen oder einen anderen Platz wählen",
        "command.search_description": "Ad-hoc-Suche über die aktuell geladenen Tage",
        "command.heatmap_description": "Datenbereitschaft für die Auslastungsvorhersage",
        "command.open_day_description": "Ganze Tagesansicht — Hinweise auf Buchungsänderungen, manuelles Aktualisieren",
