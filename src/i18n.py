...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "picker.favorites_hint": "Your favorites. Type to search all {count} clubs — 'f' favorites, 'r' refreshes the list.",
    ...
    "de": {
        ...
        "picker.favorites_hint": "Deine Favoriten. Tippen, um alle {count} Clubs zu durchsuchen — 'f' favorisiert, 'r' aktualisiert die Liste.",
