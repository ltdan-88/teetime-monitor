...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "table.precipitation": "Precip",
        "table.wind": "Wind",
        "table.events": "Events",
        "table.heat": "Occ\n08–20",
        "table.pick": "Pick",
        "events.sunrise": "Sunrise {time}",
        ...
        "legend.rain": "rain",
        "legend.rain_threshold": "rain likely",
        "legend.wind_threshold": "windy",
        "legend.event": "event/closure",
        "legend.too_late": "too late for sunset",
        "legend.changed": "changed since booked",
        "legend.usual_crowd": "usual crowd level",
        "legend.clear": "clear",
        "legend.mostly_clear": "mostly clear",
        "legend.partly_cloudy": "partly cloudy",
        "legend.overcast": "overcast",
        "legend.fog": "fog",
        "legend.drizzle": "drizzle",
        "legend.snow_showers": "snow showers",
        "legend.snow": "snow",
        "legend.thunderstorm": "thunderstorm",
        "legend.category_markers": "Markers:",
        "legend.category_weather": "Weather:",
        "legend.category_notices": "Notices:",
        "status.refreshed": "Refreshed.",
        "status.refresh_failed": "Refresh failed: {error}",
        "status.refreshing": "Refreshing…",
        "status.updated_ago": "Updated {time} ago",
        "status.just_now": "Updated just now",
        ...
        "cancel_booking.confirm": "Yes, cancel it",
        "cancel_booking.keep": "No, keep it",
        "button.save": "Save",
        ...
        "settings.group.timing": "Timing & scraping",  # legacy key, group now split
        "settings.group.account": "Account",
        "settings.group.display": "Display",
        "settings.group.scraping": "Scraping",
        "settings.group.pace": "Pace & daylight",
        "settings.field.login": "pc caddie login",
        "settings.field.language": "Language",
        "settings.field.theme": "Theme",
        "button.open": "Open",
        "preferences.title": "Preferences",
        "settings.title": "Settings",
        "binding.preferences": "Preferences",
        "command.preferences_description": "When you can play, weather limits, pace, priorities",
        "binding.refresh": "Refresh",
        "binding.collapse_all": "Collapse all",
        "binding.confirm": "Confirm tee time",
        "binding.expand_or_confirm": "Expand day / confirm tee time",
        "binding.dismiss_banners": "Dismiss banners",
        "binding.switch": "Find a club",
        "binding.cancel": "Back",
        "binding.theme": "Theme",
        "binding.quit": "Quit",
        "binding.commands": "Actions",
        "binding.open": "Open",
        ...
        "binding.keys": "Keys",
        "command.show_help_description": "Show help for the focused widget and a summary of available keys",
        "command.hide_help_description": "Hide the keys and widget help panel",
        "binding.minimize": "Minimize",
        "command.minimize_description": "Minimize the widget and restore to normal size",
        "binding.maximize": "Maximize",
        "command.maximize_description": "Maximize the focused widget",
        "binding.screenshot": "Screenshot",
        "command.screenshot_description": "Save an SVG 'screenshot' of the current screen",
        "command.quit_description": "Quit the application as soon as possible",
        ...
        "settings.field.ai_credentials": "AI provider",
        ...
        "ai_credentials.title": "AI provider",
        "ai_credentials.intro": (
            "Pick which AI provider powers AI-ranked recommendations and enter its API key. "
            "Only one provider is active at a time."
        ),
        "ai_credentials.provider_label": "Provider",
        "ai_credentials.provider_anthropic": "Anthropic (Claude)",
        "ai_credentials.provider_openai": "OpenAI (ChatGPT)",
        "ai_credentials.provider_gemini": "Google (Gemini)",
        "ai_credentials.provider_grok": "xAI (Grok)",
        "ai_credentials.api_key_label": "API key",
        "ai_credentials.api_key_hint_unset": "(not set yet)",
        "ai_credentials.api_key_hint_set": "(already set — leave blank to keep it)",
        "ai_credentials.api_key_required": "Enter an API key first.",
        "ai_credentials.verifying": "Saved — checking your key…",
        ...
        "heatmap.column.hour": "Hour",
        "heatmap.weekday_short.sunday": "Sun",
        "heatmap.weekday_short.monday": "Mon",
        "heatmap.weekday_short.tuesday": "Tue",
        "heatmap.weekday_short.wednesday": "Wed",
        "heatmap.weekday_short.thursday": "Thu",
        "heatmap.weekday_short.friday": "Fri",
        "heatmap.weekday_short.saturday": "Sat",
        "heatmap.legend.title": "Colors:",
    ...
    "de": {
        ...
        "table.day": "Datum/Zeit",
        "table.condition": "Wetter",
        "table.temperature": "Temp",
        "table.precipitation": "Regen",
        "table.wind": "Wind",
        "table.events": "Termine",
        "table.heat": "Ausl.\n08–20",
        "table.pick": "Empf.",
        "events.sunrise": "Sonnenaufgang {time}",
        ...
        "overview.no_dry_picks": "keine trockene Tee-Zeit",
        "overview.no_daylight_picks": "zu dunkel zum Fertigspielen",
        "overview.no_playable_picks": "keine spielbare Tee-Zeit",
        "overview.booked": "gebucht",
        "legend.expand": "aufklappen",
        "legend.today": "heute",
        "legend.recommended": "empfohlen",
        "legend.rain": "Regen",
        "legend.rain_threshold": "Regen wahrscheinlich",
        "legend.wind_threshold": "windig",
        "legend.event": "Termin/Sperrung",
        "legend.too_late": "Runde endet nach Sonnenuntergang",
        "legend.changed": "seit Buchung geändert",
        "legend.usual_crowd": "übliche Auslastung",
        "legend.clear": "klar",
        "legend.mostly_clear": "meist klar",
        "legend.partly_cloudy": "teilweise bewölkt",
        "legend.overcast": "bedeckt",
        "legend.fog": "Nebel",
        "legend.drizzle": "Nieselregen",
        "legend.snow_showers": "Schneeschauer",
        "legend.snow": "Schnee",
        "legend.thunderstorm": "Gewitter",
        "legend.category_markers": "Markierungen:",
        "legend.category_weather": "Wetter:",
        "legend.category_notices": "Hinweise:",
        ...
        "status.updated_ago": "Vor {time} aktualisiert",
        "status.just_now": "Gerade eben aktualisiert",
        ...
        "cancel_booking.confirm": "Ja, stornieren",
        "cancel_booking.keep": "Nein, behalten",
        ...
        "settings.group.timing": "Timing & Abruf",  # Altschlüssel, Gruppe jetzt geteilt
        "settings.group.account": "Konto",
        "settings.group.display": "Darstellung",
        "settings.group.scraping": "Abruf",
        "settings.group.pace": "Spieltempo & Tageslicht",
        "settings.field.login": "pc-caddie-Login",
        "settings.field.language": "Sprache",
        "settings.field.theme": "Design",
        "button.open": "Öffnen",
        "preferences.title": "Vorgaben",
        "settings.title": "Einstellungen",
        "binding.preferences": "Vorgaben",
        "command.preferences_description": "Wann du kannst, Wettergrenzen, Spieltempo, Prioritäten",
        "binding.refresh": "Aktualisieren",
        "binding.collapse_all": "Alle einklappen",
        "binding.confirm": "Tee-Zeit bestätigen",
        "binding.expand_or_confirm": "Tag aufklappen / Tee-Zeit bestätigen",
        "binding.dismiss_banners": "Hinweise ausblenden",
        "binding.switch": "Club suchen",
        ...
        "binding.keys": "Tasten",
        "command.show_help_description": "Hilfe zum fokussierten Element und eine Übersicht der Tastenkürzel anzeigen",
        "command.hide_help_description": "Tasten- und Hilfebereich ausblenden",
        "binding.minimize": "Minimieren",
        "command.minimize_description": "Element minimieren und auf normale Größe zurücksetzen",
        "binding.maximize": "Maximieren",
        "command.maximize_description": "Fokussiertes Element maximieren",
        "binding.screenshot": "Screenshot",
        "command.screenshot_description": "SVG-\"Screenshot\" des aktuellen Bildschirms speichern",
        "command.quit_description": "Anwendung schnellstmöglich beenden",
        "settings.field.min_open_spots": "Min. freie Plätze (Gruppengröße)",
        "settings.field.weekday_after": "Unter der Woche — ab",
        "settings.field.weekday_before": "Unter der Woche — bis",
        "settings.field.weekend_after": "Am Wochenende — ab",
        "settings.field.weekend_before": "Am Wochenende — bis",
        ...
        "settings.field.ai_credentials": "KI-Anbieter",
        ...
        "ai_credentials.title": "KI-Anbieter",
        "ai_credentials.intro": (
            "Wähle, welcher KI-Anbieter die KI-bewerteten Empfehlungen liefert, und gib dessen API-Schlüssel ein. "
            "Es ist immer nur ein Anbieter aktiv."
        ),
        "ai_credentials.provider_label": "Anbieter",
        "ai_credentials.provider_anthropic": "Anthropic (Claude)",
        "ai_credentials.provider_openai": "OpenAI (ChatGPT)",
        "ai_credentials.provider_gemini": "Google (Gemini)",
        "ai_credentials.provider_grok": "xAI (Grok)",
        "ai_credentials.api_key_label": "API-Schlüssel",
        "ai_credentials.api_key_hint_unset": "(noch nicht gesetzt)",
        "ai_credentials.api_key_hint_set": "(bereits gesetzt — leer lassen, um ihn zu behalten)",
        "ai_credentials.api_key_required": "Bitte zuerst einen API-Schlüssel eingeben.",
        "ai_credentials.verifying": "Gespeichert — Schlüssel wird geprüft…",
        ...
        "heatmap.column.hours_seen": "Std. mit Daten",
        ...
        "heatmap.column.hour": "Stunde",
        "heatmap.weekday_short.sunday": "So",
        "heatmap.weekday_short.monday": "Mo",
        "heatmap.weekday_short.tuesday": "Di",
        "heatmap.weekday_short.wednesday": "Mi",
        "heatmap.weekday_short.thursday": "Do",
        "heatmap.weekday_short.friday": "Fr",
        "heatmap.weekday_short.saturday": "Sa",
        "heatmap.legend.title": "Farben:",
