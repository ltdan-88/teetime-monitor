...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "picker.directory_needs_a_club": "Your login is saved — open a club by id and press 'f' to favorite it first, then 'r' can check the full directory.",
    ...
    "de": {
        ...
        "picker.directory_needs_a_club": "Dein Login ist gespeichert — öffne zuerst einen Club per ID und favorisiere ihn mit 'f', dann kann 'r' das ganze Verzeichnis prüfen.",
