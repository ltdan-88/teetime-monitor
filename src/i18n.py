...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "picker.directory_needs_a_club": "Your login is saved — type your club's numeric id above, then press 'r' again to check the full directory.",
    ...
    "de": {
        ...
        "picker.directory_needs_a_club": "Dein Login ist gespeichert — gib oben die Club-ID ein und drücke dann erneut 'r', um das ganze Verzeichnis zu prüfen.",
